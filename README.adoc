...
[options="header"]
|===
| mill version | mill platform | scala binary version | example
| 0.9.0 | 0.9 | 2.13 | import $ivy.`de.tototec::de.tobiasroeser.mill.integrationtest_mill0.9:{version}`
| 0.7.0 - 0.8.0 | 0.7 | 2.13 | import $ivy.`de.tototec::de.tobiasroeser.mill.integrationtest_mill0.7:{version}`
| 0.6.2 | 0.6.2 | 2.12 | import $ivy.`de.tototec::de.tobiasroeser.mill.integrationtest_mill0.6.2_2.12:{version}`
|===
