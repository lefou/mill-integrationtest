...
val millApiCrossVersions = Seq(
  new CrossConfig {
    override def millPlatform = "0.11.0-M9" // only valid for exact milestone releases
    override def minMillVersion: String = "0.11.0-M9" // needs to be an exact milestone release
