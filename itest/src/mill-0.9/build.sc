// A project targeting Mill 0.9.12, testing against Mill 0.9.3 and latest 0.9.x
...
object demoplugin extends DemoModule {
  override def compileIvyDeps = Agg(
    ivy"com.lihaoyi::mill-main:0.9.3" // scala-steward:off
  )
}
...
object itest extends Cross[ItestCross]("0.9.3", "0.9.12")
